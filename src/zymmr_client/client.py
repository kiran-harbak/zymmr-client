...
class ZymmrClient:
    ...
    This client provides a simple, intuitive interface for interacting with
    Zymmr's REST API built on Frappe Framework v14. It handles authentication,
    session management, and provides methods for common operations.
